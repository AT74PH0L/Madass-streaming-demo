...
import { Movie } from "@/components/AdminMovies/type";
import { DeleteMovieDialog } from "@/components/studio/DeleteMovieDialog";
import { EditMovieDialog } from "@/components/studio/EditMovieDialog";
  ...
  const fetchMovies = useCallback(async () => {
    ...
    try {
      ...
      if (response.data) {
        ...
        setHasMore(response.data.hasMore); // API should return `hasMore`
      }
    } catch (error) {
